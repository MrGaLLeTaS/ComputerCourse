 ...
 */
    function(e) {
        var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, m, y, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, S = ue(), E = ue(), k = ue(), A = ue(), D = function(e, t) {
            return e === t && (f = !0),
            0
        }, j = {}.hasOwnProperty, N = [], L = N.pop, q = N.push, H = N.push, O = N.slice, P = function(e, t) {
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, M = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", $ = "\\[" + R + "*(" + I + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + R + "*\\]", W = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)", _ = new RegExp(R + "+","g"), F = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), B = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), U = new RegExp(R + "|>"), X = new RegExp(W), V = new RegExp("^" + I + "$"), Q = {
            ID: new RegExp("^#(" + I + ")"),
            CLASS: new RegExp("^\\.(" + I + ")"),
            TAG: new RegExp("^(" + I + "|[*])"),
            ATTR: new RegExp("^" + $),
        ...
        }, G = /HTML$/i, Y = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
                ...
                (s = k(e, function(e, t) {
                    var n = t.length > 0
                      ...
                      , o = function(o, a, s, u, c) {
                        var f, h, v, m = 0, y = "0", x = o && [], b = [], w = l, C = o || i && r.find.TAG("*", c), S = T += null == w ? 1 : Math.random() || .1, E = C.length;
    ...
    b.each({
        ...
        b.fn[e] = function(n, r) {
            ...
            this.length > 1 && (q[e] || b.uniqueSort(i),
            L.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }
                            ...
                            var s = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    h(l) ? i ? l.call(e, a(o, n, P, i), a(o, n, M, i)) : (o++,
                                    l.call(e, a(o, n, P, i), a(o, n, M, i), a(o, n, P, n.notifyWith))) : (r !== P && (s = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(s, u))
                                }
                            }
    ...
    b.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --b.readyWait > 0 || $.resolveWith(v, [b]))
        }
    }),
    b.ready.then = $.then,
    ...
    b.fn.extend({
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each((function() {
                ...
                var n;
                if (o && void 0 === t)
                    return void 0 !== (n = G.get(o, e)) || void 0 !== (n = K(o, e)) ? n : void 0;
                this.each((function() {
                    G.set(this, e, t)
                }
                ))
    ...
    b.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = Q.get(e, t),
                n && (!r || Array.isArray(n) ? r = Q.access(e, t, b.makeArray(n)) : r.push(n)),
                r || []
        },
        ...
        b.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    r = n(this, t),
                    this[t](),
                    a !== (o = Q.get(this, t)) || r ? Q.set(this, t, !1) : o = {},
                    a !== o)
    ...
    b.event = {
        ...
        dispatch: function(e) {
            var t, n, r, i, o, a, s = new Array(arguments.length), u = b.event.fix(e), l = (Q.get(this, "events") || Object.create(null))[u.type] || [], c = b.event.special[u.type] || {};
            for (s[0] = u,
        ...
        special: {
            ...
            click: {
                ...
                _default: function(e) {
                    var t = e.target;
                    return pe.test(t.type) && t.click && k(t, "input") && Q.get(t, "click") || k(t, "a")
                }
            },
            beforeunload: {
    ...
    function Me(e, t, n, r) {
        t = o(t);
        var i, a, s, u, l, c, f = 0, p = e.length, g = p - 1, v = t[0], m = h(v);
        if (m || p > 1 && "string" == typeof v && !d.checkClone && je.test(v))
        ...
        a || r)) {
            for (u = (s = b.map(ve(i, "script"), qe)).length; f < p; f++)
                l = i,
                f !== g && (l = b.clone(l, !0, !0),
            ...
            if (u)
                ...
                f = 0; f < u; f++)
                    l = s[f],
                    he.test(l.type || "") && !Q.access(l, "globalEval") && b.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? b._evalUrl && !l.noModule && b._evalUrl(l.src, {
    ...
    function Re(e, t, n) {
        for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && re(r) && me(ve(r, "script")),
    ...
    b.extend({
        ...
        clone: function(e, t, n) {
            var r, i, o, a, s = e.cloneNode(!0), u = re(e);
            ...
            if (t)
                if (n)
                    ...
                    Oe(e, s);
            return (a = ve(s, "script")).length > 0 && me(a, !u && ve(e, "script")),
            s
        },
    ...
    var Ie = new RegExp("^(" + Z + ")(?!px)[a-z%]+$","i")
      ...
      , _e = new RegExp(te.join("|"),"i");
    function Fe(e, t, n) {
        var r, i, o, a, s = e.style;
        return (n = n || $e(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = b.style(e, t)),
        !d.pixelBoxStyles() && Ie.test(a) && _e.test(t) && (r = s.width,
        i = s.minWidth,
        o = s.maxWidth,
    ...
    b.each(["height", "width"], (function(e, t) {
        b.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !Qe.test(b.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? et(e, t, r) : We(e, Ye, (function() {
                        return et(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var i, o = $e(e), a = !d.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === b.css(e, "boxSizing", !1, o), u = r ? Ze(e, t, r, s, o) : 0;
    ...
    b.cssHooks.marginLeft = Be(d.reliableMarginLeft, (function(e, t) {
        if (t)
    ...
    function at() {
        rt && (!1 === v.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, b.fx.interval),
        b.fx.tick())
    }
    function st() {
    ...
    b.Animation = b.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && oe(e), v = Q.get(e, "fxshow");
    ...
    b.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = Q.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = b.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                b.queue(this, e, []),
    ...
    b.extend(b.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, u, l, f, p, d, m = [r || v], y = c.call(t, "type") ? t.type : t, x = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = d = s = r = r || v,
            3 !== r.nodeType && 8 !== r.nodeType && !xt.test(y + b.event.triggered) && (y.indexOf(".") > -1 && (x = y.split("."),
            y = x.shift(),
            x.sort()),
            l = y.indexOf(":") < 0 && "on" + y,
            ...
            i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
                    ...
                    xt.test(u + y) || (a = a.parentNode); a; a = a.parentNode)
                        m.push(a),
                        s = a;
                ...
                return t.type = y,
                i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(m.pop(), n) || !X(r) || l && h(r[y]) && !g(r) && ((s = r[l]) && (r[l] = null),
                b.event.triggered = y,
                t.isPropagationStopped() && d.addEventListener(y, bt),
                r[y](),
                t.isPropagationStopped() && d.removeEventListener(y, bt),
    ...
    b.extend({
        ...
        ajaxSetup: function(e, t) {
            return t ? _t(_t(e, b.ajaxSettings), t) : _t(b.ajaxSettings, e)
        },
        ajaxPrefilter: $t(Pt),
        ajaxTransport: $t(Mt),
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, i, o, a, s, u, l, c, f, p, d = b.ajaxSetup({}, n), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? b(h) : b.event, m = b.Deferred(), y = b.Callbacks("once memory"), x = d.statusCode || {}, w = {}, T = {}, C = "canceled", S = {
                readyState: 0,
            ...
            if (m.promise(S),
            d.url = ((t || d.url || wt.href) + "").replace(Ot, wt.protocol + "//"),
            ...
            null == d.crossDomain) {
                ...
                try {
                    u.href = d.url,
                    u.href = u.href,
                    d.crossDomain = It.protocol + "//" + It.host != u.protocol + "//" + u.host
                } catch (e) {
                    d.crossDomain = !0
                }
            }
            ...
            d.url = i + p),
            d.ifModified && (b.lastModified[i] && S.setRequestHeader("If-Modified-Since", b.lastModified[i]),
            ...
            S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Rt + "; q=0.01" : "") : d.accepts["*"]),
            d.headers)
            ...
            function E(t, n, a, u) {
                ...
                f ? (d.ifModified && ((T = S.getResponseHeader("Last-Modified")) && (b.lastModified[i] = T),
    ...
    d.createHTMLDocument = ((zt = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    b.each(["top", "left"], (function(e, t) {
        b.cssHooks[t] = Be(d.pixelPosition, (function(e, n) {
            if (n)
                return n = Fe(e, t),
...
$((function() {
    !function e(t, n) {
        var r = document.getElementById(t)
          , i = r.querySelector(".days")
          , o = r.querySelector(".hours")
          , a = r.querySelector(".minutes")
          , s = r.querySelector(".seconds");
        function u() {
            var t = function(e) {
            ...
            t.total <= 0 && (clearInterval(l),
            e("countdown", new Date(Date.parse(new Date) + 5e3)));
            i.innerHTML = t.days,
            o.innerHTML = ("0" + t.hours).slice(-2),
            a.innerHTML = ("0" + t.minutes).slice(-2),
            s.innerHTML = ("0" + t.seconds).slice(-2)
        }
        u();
        var l = setInterval(u, 1e3)
    }("countdown", new Date(Date.parse(new Date) + 15552e5)),
    ...
    $(window).scroll((function() {
        $(this).scrollTop() > 100 ? $(".header__top").addClass("fixed") : $(".header__top").removeClass("fixed"),
        $(window).width() < 904 && $(".header__top").removeClass("fixed")
    }
    ));
    var e = document.querySelectorAll(" .programm__timeline .programm__item");
    function t() {
        for (var t = 0; t < e.length; t++)
            n = e[t],
            r = void 0,
            (r = n.getBoundingClientRect()).top >= 0 && r.left >= 0 && r.bottom <= (window.innerHeight || document.documentElement.clientHeight) && r.right <= (window.innerWidth || document.documentElement.clientWidth) && e[t].classList.add("in-view");
        var n, r
    }
